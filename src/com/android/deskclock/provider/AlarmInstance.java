...
public final class AlarmInstance implements ClockContract.InstancesColumns {
    ...
    private static final int LIGHT_ENABLED_INDEX = 11;
    private static final int LIGHT_COLOR_INDEX = 12;
    private static final int LIGHT_TIME_INDEX = 13;
    ...
    public static ContentValues createContentValues(AlarmInstance instance) {
        ...
        values.put(LIGHT_ENABLED, instance.mLightEnabled);
        values.put(LIGHT_COLOR, instance.mLightColor);
        values.put(LIGHT_TIME, instance.mLightTime);
    ...
    public AlarmInstance(Cursor c) {
        ...
        mLightEnabled = c.getInt(LIGHT_ENABLED_INDEX) == 1;
        mLightColor = c.getInt(LIGHT_COLOR_INDEX);
        mLightTime = c.getInt(LIGHT_TIME_INDEX);
