...
class ClockDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String DEFAULT_ALARM_1 = "(8, 30, 31, 0, 0, 0, 0, 0, '', NULL, 0);";

    // This creates a default alarm at 9:30 for every Sat,Sun
    private static final String DEFAULT_ALARM_2 = "(9, 00, 96, 0, 0, 0, 0, 0, '', NULL, 0);";
    ...
    private static void createAlarmsTable(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE " + ALARMS_TABLE_NAME + " (" +
                ...
                ClockContract.AlarmsColumns.LIGHT_ENABLED + " INTEGER NOT NULL DEFAULT 0, " +
                ClockContract.AlarmsColumns.LIGHT_COLOR + " INTEGER NOT NULL DEFAULT 0, " +
                ClockContract.AlarmsColumns.LIGHT_TIME + " INTEGER NOT NULL DEFAULT 0, " +
    ...
    private static void createInstanceTable(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE " + INSTANCES_TABLE_NAME + " (" +
                ...
                ClockContract.InstancesColumns.LIGHT_ENABLED + " INTEGER NOT NULL DEFAULT 0, " +
                ClockContract.InstancesColumns.LIGHT_COLOR + " INTEGER NOT NULL DEFAULT 0, " +
                ClockContract.InstancesColumns.LIGHT_TIME + " INTEGER NOT NULL DEFAULT 0, " +
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String insertMe = "INSERT INTO " + ALARMS_TABLE_NAME + " (" +
                ...
                ClockContract.AlarmsColumns.LIGHT_ENABLED + cs +
                ClockContract.AlarmsColumns.LIGHT_COLOR + cs +
                ClockContract.AlarmsColumns.LIGHT_TIME + cs +
